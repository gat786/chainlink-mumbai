...
export default function SideNav() {
  ...
  return (
    <div className={`lg:w-full lg:z-10 absolute bg-gray-700 bg-opacity-80 ` +
        `${isOpen ? styles.openRoot : styles.closedRoot}`}
        onClick={() => { toggleNav() }}>
        <nav className={`${styles.root} ${styles.open} shadow-lg shadow-gray-400`}>
