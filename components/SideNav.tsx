...
export default function SideNav(props: {
	...
	return (
		<>
			<div className={'lg:relative absolute w-full lg:w-80 h-screen'
				+ props.isOpen && `${styles.openSideNav}`}>
				<div className={`lg:w-0 absolute h-screen transition-all bg-gray-700 bg-opacity-80 ` +
					`${props.isOpen ? styles.openBg : styles.closedBg}`}
